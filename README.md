...
11. Скриншот реального успешного catch в `docs/example-success-catch-white-ip.png`.
...
- [Пример: успешный catch](#пример-успешный-catch)
...
## Пример: успешный catch

<div align="center">

<img src="docs/example-success-catch-white-ip.png" alt="Terminal: npm run slow — батчи по зонам, сообщение УСПЕХ и блок с IP 51.250.x.x" width="820" />

<sub><strong>Реальный вывод терминала:</strong> ротация зон <code>a, b, d</code>, пауза между батчами, затем совпадение с префиксом <code>51.250.</code> и финальный блок с зоной и именем ресурса. Часть адреса на скриншоте скрыта вручную; в публичных репозиториях не публикуйте полные IP и <code>folder-id</code>.</sub>
...
| `docs/` | Иллюстрации для README (например скриншот успешного catch) |
